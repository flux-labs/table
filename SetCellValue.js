...
function parseAlphaNumIndex(index) {
	...
	for (var l = 0; l < index.length; l++){
		...
		// When the character is an integer
		else{
...
function run(Table, Index, Value) {
	var colIndex = 0;
	var rowIndex = 0;
